...
class ModelCode extends CCodeModel
{
	...
	public $tableName;
	public $modelClass;
	public $giiModelPath='application.giimodels';
  public $modelPath='application.models';
	public $baseClass='CActiveRecord';
	public $buildRelations=true;
  public $buildBases=true;
  public $buildModels=true;
	...
	public function rules()
	{
		return array_merge(parent::rules(), array(
			array('tablePrefix, baseClass, tableName, modelClass, modelPath, giiModelPath, connectionId', 'filter', 'filter'=>'trim'),
			array('connectionId, tableName, modelPath, giiModelPath, baseClass', 'required'),
			array('tablePrefix, tableName, modelPath, giiModelPath', 'match', 'pattern'=>'/^(\w+[\w\.]*|\*?|\w+\.\*)$/', 'message'=>'{attribute} should only contain word characters, dots, and an optional ending asterisk.'),
      ...
      array('giiModelPath', 'validateGiiModelPath', 'skipOnError'=>true),
			array('baseClass, modelClass', 'validateReservedWord', 'skipOnError'=>true),
			array('baseClass', 'validateBaseClass', 'skipOnError'=>true),
			array('connectionId, tablePrefix, modelPath, giiModelPath, baseClass, buildRelations, buildBases, buildModels, commentsAsLabels', 'sticky'),
		));
	}
	...
	public function attributeLabels()
	{
      ...
      'giiModelPath'=>'Gii Model Path',
			'modelClass'=>'Model Class',
			'baseClass'=>'Base Class',
			'buildRelations'=>'Build Relations',
      'buildBases'=>'Build Base Files',
      'buildModels'=>'Build Model Files',
	...
	public function prepare()
	{
      ...
      if ($this->buildBases) {
  			$this->files[]=new CCodeFile(
  				Yii::getPathOfAlias($this->giiModelPath).'/'.$fileName.'.php',
  ...
  public function validateGiiModelPath($attribute,$params)
  {
    if(Yii::getPathOfAlias($this->giiModelPath)===false)
      $this->addError('giiModelPath','Gii Model Path must be a valid path alias.');
  }
