...
<?php $form=$this->beginWidget('CCodeForm', array('model'=>$model)); ?>
  ...
  <div class="row sticky">
    <?php echo $form->labelEx($model,'giiModelPath'); ?>
    <?php echo $form->textField($model,'giiModelPath', array('size'=>65)); ?>
    <div class="tooltip">
      This refers to the directory that the new model class file should be generated under.
      It should be specified in the form of a path alias, for example, <code>application.models</code>.
    </div>
    <?php echo $form->error($model,'giiModelPath'); ?>
  </div>
	<div class="row">
  ...
  <div class="row">
    <?php echo $form->labelEx($model,'buildBases'); ?>
    <?php echo $form->checkBox($model,'buildBases'); ?>
    <div class="tooltip">
      Build a model base files with Relations
    </div>
    <?php echo $form->error($model,'buildBases'); ?>
  </div>
  <div class="row">
    <?php echo $form->labelEx($model,'buildModels'); ?>
    <?php echo $form->checkBox($model,'buildModels'); ?>
    <div class="tooltip">
      Build a model files
    </div>
    <?php echo $form->error($model,'buildModels'); ?>
  </div>
	<div class="row">
